...
export default function Planet ({props}: PlanetProps) {
    ...
    return (
       ...
       {props.map((item, index) => {
        ...
        <div className="xl:w-[540px] mt-[50.5px] md:mt-[42px] mb-[58.5px] md:mb-[86px] flex justify-center items-center">    
       ...
       <ul className="font-barlow flex gap-4 items-center justify-center text-[16px] text-[#D0D6F9] ">
       ...
       <h1 className="font-bellefair mt-8 flex justify-center items-center text-[56px] md:text-[80px] mb-6 md:p-0">{item.name}</h1>
       <p className="font-barlow_norm mb-6 text-center flex justify-center items-center text-base text-[#D0D6F9] md:pr-[87px] md:pl-[87px]">{item.description}</p>
       <hr className="h-[1px] border-[#979797] mb-6 md:mr-[87px] md:ml-[87px]"/>
