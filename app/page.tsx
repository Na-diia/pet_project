...
export default function Home() {
  return (
   ...
   <p className=" md:w-[512px] text-[#D0D6F9] mt-12 text-lg text-center xl:text-start">Let’s face it; if you want to go to space, you might as well genuinely go to outer space and not hover kind of on the edge of it. Well sit back, and relax because we’ll give you a truly out of this world experience!</p>
   </div>
