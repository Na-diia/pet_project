...
export default function TeamPage ({params}: {params:{team: string}}) {
    ...
    return (
        ...
        xl:bg-[url(../public/images/crew/background-crew-desktop.jpg)] bg-cover bg-no-repeat items-center justify-items-center min-h-screen w-full p-8 md:pr-10 md:pl-10 md:pt-10 md:pb-0 xl:pr-[165px] xl:pl-[165px] xl:pb-12">
        <div className='pt-6 md:pt-10 xl:pt-[144px] pb-6 w-full mt-[56px] xl:mt-0'>
